...
bool frmKyt::CheckInputs(){
    ...
    QRegularExpression regexMail("\\b[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[A-Z]{2,4}\\b",
                                 QRegularExpression::CaseInsensitiveOption );
    
//    regexMail.setPatternSyntax(QRegularExpression::RegExp);

    //QRegExp regexPhone("^[0-9]{10}$");
    QRegularExpression regexPhone("0\\d\\d\\d\\d\\d\\d\\d\\d\\d\\d",
                                  QRegularExpression::CaseInsensitiveOption );
