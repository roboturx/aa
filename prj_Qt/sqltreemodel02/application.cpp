...
//    initializeLanguage();
 ...
 //   setStyle( new XmlUi::WindowsStyle() );
    ...
    setWindowIcon( QIcon( "./icons/webissues-48.png" ) );
...
//    dialogManager = new DialogManager();
  ...
  //  m_manager = new QNetworkAccessManager();
   ...
   // connect( m_updateClient, SIGNAL( stateChanged() ), this,
      //       SLOT( showUpdateState() ) );

    //settingsChanged();

//    connect( m_settings, SIGNAL( settingsChanged() ), this,
...
{
    QString message;
    message += "<h3>WebIssues Desktop Client %1</h3>";
    message += "<p> Desktop Client for the WebIssues team collaboration system.</p>";
    message += "<p>This program is free software: you can redistribute it and/or modify"
        " it under the terms of the GNU General Public License as published by"
        " the Free Software Foundation, either version 3 of the License, or"
        " (at your option) any later version.</p>";
    message += "<p>opyright &copy; 2006 Michał Męciński<br>007-2017 WebIssues Team</p>";
...
//    if ( tryQtDir && translator->load( fullName, QLibraryInfo::path( QLibraryInfo::TranslationsPath ) ) ) {
//        installTranslator( translator );
//        return true;
//    }
...
#if defined( Q_OS_WIN )
    setApplicationName( "in initialpath - applctn.cpp" );
...
{
    return QFontMetrics( m_editorFont ).height() *
            m_settings->value( "TextSizeMultiplier" ).toInt() / 1300.0;
}
