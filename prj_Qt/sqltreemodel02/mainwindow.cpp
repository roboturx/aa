...
//    columns << "Column_Name" << "Column_Address" << "Column_Phone";
    ...
    QSqlTableModel* projectsModel = new QSqlTableModel( this );
    projectsModel = new QSqlTableModel( this );
...
//    PersonsFilter* filter = new PersonsFilter( m_manager );
 /*   connect( searchEdit, SIGNAL( textChanged( const QString& ) ),
             filter, SLOT( setNameFilter( const QString& ) ) );
*/
     QSqlTableModel* personsModel = new QSqlTableModel( this );
