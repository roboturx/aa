...
QT_MOC_LITERAL(12, 15), // "projectsChanged"
QT_MOC_LITERAL(28, 0), // ""
QT_MOC_LITERAL(29, 14) // "personsChanged"

    },
    "DataManager\0projectsChanged\0\0"
    "personsChanged"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::projectsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DataManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::personsChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DataManager::projectsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DataManager::personsChanged()
{
