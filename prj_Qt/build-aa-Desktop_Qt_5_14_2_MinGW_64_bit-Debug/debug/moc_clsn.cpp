...
struct qt_meta_stringdata_hC_CLSN_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_hC_CLSN_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_hC_CLSN_t qt_meta_stringdata_hC_CLSN = {
    {
QT_MOC_LITERAL(0, 0, 7) // "hC_CLSN"
...
static const uint qt_meta_data_hC_CLSN[] = {
...
QT_INIT_METAOBJECT const QMetaObject hC_CLSN::staticMetaObject = { {
    QMetaObject::SuperData::link<hC_tBcreator::staticMetaObject>(),
    qt_meta_stringdata_hC_CLSN.data,
    qt_meta_data_hC_CLSN,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *hC_CLSN::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_hC_CLSN.stringdata0))
