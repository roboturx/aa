...
hC_TextEdit::hC_TextEdit(QWidget *parent)
    : QMainWindow(parent)
{
#ifdef Q_OS_MACOS
...

    {
        ...
        helpMenu->addAction(tr("About"), this, &hC_TextEdit::about);
    ...
    connect(QGuiApplication::clipboard(), &QClipboard::dataChanged,
            this, &hC_TextEdit::clipboardDataChanged);
#endif
...
void hC_TextEdit::closeEvent(QCloseEvent *e)
{
    if (maybeSave())
        e->accept();
    else
...
void hC_TextEdit::setupFileActions()
{
    ...
    QAction *a = menu->addAction(newIcon,  tr("&New"), this, &hC_TextEdit::fileNew);
    tb->addAction(a);
    a->setPriority(QAction::LowPriority);
    a->setShortcut(QKeySequence::New);

    const QIcon openIcon = QIcon::fromTheme("document-open", QIcon(rsrcPath + "/fileopen.png"));
    a = menu->addAction(openIcon, tr("&Open..."), this, &hC_TextEdit::fileOpen);
    ...
    actionSave = menu->addAction(saveIcon, tr("&Save"), this, &hC_TextEdit::fileSave);
    actionSave->setShortcut(QKeySequence::Save);
    actionSave->setEnabled(false);
    tb->addAction(actionSave);

    a = menu->addAction(tr("Save &As..."), this, &hC_TextEdit::fileSaveAs);
    a->setPriority(QAction::LowPriority);
    menu->addSeparator();
...
void hC_TextEdit::setupEditActions()
{
...
void hC_TextEdit::setupTextActions()
{
    QToolBar *tb = addToolBar(tr("Format Actions"));
    QMenu *menu = menuBar()->addMenu(tr("F&ormat"));

    const QIcon boldIcon = QIcon::fromTheme("format-text-bold", QIcon(rsrcPath + "/textbold.png"));
    actionTextBold = menu->addAction(boldIcon, tr("&Bold"), this, &hC_TextEdit::textBold);
    ...
    actionTextItalic = menu->addAction(italicIcon, tr("&Italic"), this, &hC_TextEdit::textItalic);
    ...
    actionTextUnderline = menu->addAction(underlineIcon, tr("&Underline"),
                               this, &hC_TextEdit::textUnderline);
    ...
    const QIcon indentMoreIcon = QIcon::fromTheme("format-indent-more",
                               QIcon(rsrcPath + "/format-indent-more.png"));
    actionIndentMore = menu->addAction(indentMoreIcon, tr("&Indent"),
                                   this, &hC_TextEdit::indent);
    ...
    const QIcon indentLessIcon = QIcon::fromTheme("format-indent-less",
                   QIcon(rsrcPath + "/format-indent-less.png"));
    actionIndentLess = menu->addAction(indentLessIcon, tr("&Unindent"),
                                       this, &hC_TextEdit::unindent);
    ...
    connect(alignGroup, &QActionGroup::triggered, this, &hC_TextEdit::textAlign);
    ...
    QPixmap pix(16, 16);
    pix.fill(Qt::black);
    actionTextColor = menu->addAction(pix, tr("&Color..."), this, &hC_TextEdit::textColor);
    tb->addAction(actionTextColor);

    const QIcon underlineColorIcon(rsrcPath + "/textundercolor.png");
    actionUnderlineColor = menu->addAction(underlineColorIcon, tr("Underline color..."),
                                           this, &hC_TextEdit::underlineColor);
    ...
    actionToggleCheckState = menu->addAction(checkboxIcon, tr("Chec&ked"), this, &hC_TextEdit::setChecked);
    ...
    comboStyle->addItems({"Standard",
        ...
        connect(comboStyle, &QComboBox::activated, this, &hC_TextEdit::textStyle);

    comboFont = new QFontComboBox(tb);
    tb->addWidget(comboFont);
    connect(comboFont, &QComboBox::textActivated, this, &hC_TextEdit::textFamily);
    ...
    connect(comboSize, &QComboBox::textActivated, this, &hC_TextEdit::textSize);
}

bool hC_TextEdit::load(const QString &f)
{
    if (!QFile::exists(f))
        return false;
    QFile file(f);
    ...
    if (mimeTypeName == u"text/html") {
        ...
        //        QString str = QStringDecoder(encoding ? *encoding :
        //                            QStringDecoder::Utf8)(data);
...
void hC_TextEdit::setCurrentFileName(const QString &fileName)
{
...
void hC_TextEdit::filePrintPreview()
{
...
void hC_TextEdit::textUnderline()
{
    QTextCharFormat fmt;
...
void hC_TextEdit::textFamily(const QString &f)
{
    QTextCharFormat fmt;
...
void hC_TextEdit::textSize(const QString &p)
{
...
void hC_TextEdit::textStyle(int styleIndex)
{
...
void hC_TextEdit::underlineColor()
{
...
void hC_TextEdit::textAlign(QAction *a)
{
...
void hC_TextEdit::setChecked(bool checked)
{
    textStyle(checked ? 5 : 4);
}

void hC_TextEdit::indent()
{
    modifyIndentation(1);
}

void hC_TextEdit::unindent()
{
    modifyIndentation(-1);
}

void hC_TextEdit::modifyIndentation(int amount)
{
    QTextCursor cursor = textEdit->textCursor();
    cursor.beginEditBlock();
    if (cursor.currentList()) {
...
void hC_TextEdit::currentCharFormatChanged(const QTextCharFormat &format)
{
    fontChanged(format.font());
    colorChanged(format.foreground().color());
}

void hC_TextEdit::cursorPositionChanged()
{
    alignmentChanged(textEdit->alignment());
...
void hC_TextEdit::clipboardDataChanged()
{
#ifndef QT_NO_CLIPBOARD
    if (const QMimeData *md = QGuiApplication::clipboard()->mimeData())
        actionPaste->setEnabled(md->hasText());
...
void hC_TextEdit::mergeFormatOnWordOrSelection(const QTextCharFormat &format)
{
    QTextCursor cursor = textEdit->textCursor();
...
void hC_TextEdit::fontChanged(const QFont &f)
{
...
void hC_TextEdit::colorChanged(const QColor &c)
{
    QPixmap pix(16, 16);
    pix.fill(c);
...
void hC_TextEdit::alignmentChanged(Qt::Alignment a)
{
...
QTextEdit *hC_TextEdit::getTextEdit() const
{
    return textEdit;
}

void hC_TextEdit::setTextEdit(QTextEdit *newTextEdit)
{
