...
bool DataBase::insertIntoHesapTable() //const QVariantList &data
{
    ...
    query.bindValue(":A", "hesap kodu"); // kod
    query.bindValue(":B", "hesap adı"); // ad
    query.bindValue(":C", "ana hesap"); // parent
    query.bindValue(":D", "açıklama"); // açıklama
    query.bindValue(":E", "para birimi"); // para birimi
    query.bindValue(":F", "para birim kesiri"); // para birim kesir
    query.bindValue(":G", true); // ana hesap mı
    query.bindValue(":H", false); // gizli mi
