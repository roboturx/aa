...
public:
    //constructor
 //   ExpandedNode();
//    ExpandedNode(const ExpandedNode &other)
//    {
...
public:
 //   ExpandedNode &operator = (const ExpandedNode&);
...
typedef ExpandedNode ExpandedNode;
Q_DECLARE_METATYPE( ExpandedNode )
...
public:
    ...
    */
    void initializeView( ViewFlags flags  );
