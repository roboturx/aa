...
QModelIndex TreeItemModel::index(
...
TreeItem* TreeItemModel::categoryFromIndex(
...
QVariant TreeItemModel::headerData(
...
void TreeItemModel::setupModel( TreeItem* parent )
{
    ...
    if( q.prepare(
    "select * from table11 ( contractor_tree.GetCategoryTree"
                           "  (:pid,:depth) )"))
