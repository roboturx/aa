...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_hC_CLSN_t, stringdata0) + ofs), len 
...
const QMetaObject hC_CLSN::staticMetaObject = { {
    QMetaObject::SuperData::link<hC_tBcreator::staticMetaObject>(),
    qt_meta_stringdata_hC_CLSN.offsetsAndSize,
    qt_meta_data_hC_CLSN,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_hC_CLSN_t
